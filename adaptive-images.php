...
/* PROJECT INFO --------------------------------------------------------------------------------------------------------
   ...
   ** NOTE: This script has been updated to run on the IST Serenity server **
   **       It allows for images to be nested inside of directories        **
   **                                                                      **
   **       Update the $document_root path on line 22                      **
   **                                                                      **
...
$document_root = "/home/MAIN/arp6333/Sites/252/project2/";
...
$source_file    = $_SERVER["CONTEXT_DOCUMENT_ROOT"] . str_replace( $_SERVER["CONTEXT_PREFIX"], "", $_SERVER["REQUEST_URI"] );
$resolution     = FALSE;
